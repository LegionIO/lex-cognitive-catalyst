      ...
      module Runners
        module CognitiveCatalyst
          ...
          def create_catalyst(catalyst_type:, domain:, potency: nil, specificity: nil, engine: nil, **)
            ...
            Legion::Logging.warn "[cognitive_catalyst] create_catalyst failed: #{ex.message}"
            { success: false, reason: ex.message }
          end
          ...
          def create_reaction(reaction_type:, reactants:, activation_energy: nil, engine: nil, **)
            ...
            Legion::Logging.warn "[cognitive_catalyst] create_reaction failed: #{ex.message}"
            { success: false, reason: ex.message }
          end
